        ...
        RoomViewLayout(content: {
            Group{
                if let exercise = viewModel.currentExercise {
                    CodeEditorView(project: Project(worldWidth: exercise.worldWidth, worldLength: exercise.worldLength, name: exercise.exerciseName, exercise: exercise), shouldSave: false)
